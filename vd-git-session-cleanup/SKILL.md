---
name: vd-git-session-cleanup
description: Clean up temporary scripts and files created during skill usage sessions. Analyzes uncommitted changes in context of recent git history, categorizes untracked files for deletion/preservation. Use when cleaning up after development sessions.
---

# Git Session Cleanup

Clean up your git working directory after skill usage sessions, including analyzing uncommitted functional work and test fixes.
...
2. **Reusable utilities** - Consider moving to `scripts/` or appropriate location
